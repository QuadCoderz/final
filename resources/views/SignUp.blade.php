	...
	<div class="container">
		<section id="content">
			<form action="">
				...
				<div>
					<input type="password" name="Cpassword" maxlength="30" placeholder="Confirm Password" required/>
				</div>
				
				
				<div>
					<input type="tel" name="Phone" maxlength="20" placeholder="Phone"  required/>
				</div>
				<div>
					<input type="number" name="Age"  placeholder="Age"  required >
				</div>
				<div>
					<input type="submit" value="Sign Up" style="margin-left:120px" />
				</div>
				<div>
					<button style="height:40px; background-color:blue;border-radius:12px; margin-bottom:10px;">Sign Up With Facebook</button>
				</div>
