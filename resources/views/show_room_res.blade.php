...
@section('content')
    ...
    <div class="container" >
        <div class="row">
            <div class="col-lg-12">
                <hr>
                <h2 class="intro-text text-center">Room Res.
    ...
    <div class="container" >
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                $reg=\App\roomReservation::where('confirm','=',false)->get();
   ...
   <tr>
	<hr>
	  ...
	  <td>
	       ...
	       <button type="button" class="btn btn-danger" onclick="window.location.href='/delete_room_res/$r->id'">Delete</button>
	       <button type="button" class="btn btn-warning" onclick="window.location.href='/set/$r->id'">View</button>
	       	       <button type="button" class="btn btn-warning" onclick="window.location.href='/confirm/$r->id'">Confirm</button>
